...
const AboutBaithak = () => {
  return (
    <section className="relative bg-black py-32 px-6 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[url('/assets/images/aboutbanner.jpg')] bg-cover bg-center bg-fixed opacity-65 z-0" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <motion.div
          ...
          className="p-6 sm:p-8 rounded-3xl space-y-8"
        >
          <header>
        ...
        >
          <img
            ...
            alt="Inside Baithak"
            loading="lazy"
            className="object-cover w-full h-full max-h-[500px] transition-transform duration-700 ease-in-out hover:scale-105 rounded-3xl"
          />
        </motion.div>
      </div>
    </section>
