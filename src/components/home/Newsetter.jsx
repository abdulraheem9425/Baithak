...
const NewsletterSignup = () => {
  ...
  return (
    <section className="bg-black py-20 px-6 sm:px-10 lg:px-24 flex flex-col items-center">
      <motion.h2
        className="text-4xl sm:text-5xl font-extrabold text-yellow-500 mb-4 text-center tracking-tight"
      ...
      <motion.p
        className="text-gray-300 max-w-xl text-center mb-10 text-base sm:text-lg px-4"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <button
          type="submit"
          className="bg-yellow-500 text-black font-bold text-base sm:text-lg px-10 py-3 rounded-full hover:bg-yellow-600 transition-shadow shadow-md hover:shadow-xl w-full sm:w-auto"
        >
          Subscribe
        </button>
      </motion.form>
